...
QuickHashIntSet::loadFromFile() expects parameter 3 to be integer, string given
QuickHashIntSet::loadFromFile() expects parameter 2 to be integer, string given
