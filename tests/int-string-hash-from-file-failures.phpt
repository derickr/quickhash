...
QuickHashIntStringHash::loadFromFile() expects parameter 3 to be integer, string given
QuickHashIntStringHash::loadFromFile() expects parameter 2 to be integer, string given
...
Non existing: 
QuickHashIntStringHash::loadFromFile(%stests/does-not-exist.set): failed to open stream: No such file or directory
