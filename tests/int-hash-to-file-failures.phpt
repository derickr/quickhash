...
Directory: 
QuickHashIntHash::saveToFile(%stests): failed to open stream: Is a directory

URL: 
QuickHashIntHash::saveToFile(http://derickrethans.nl/): failed to open stream: HTTP wrapper does not support writeable connection%s
