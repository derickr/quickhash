...
QuickHashIntHash::loadFromFile() expects parameter 3 to be integer, string given
QuickHashIntHash::loadFromFile() expects parameter 2 to be integer, string given
