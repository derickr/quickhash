...
static void qh_object_free_storage_intstringhash(zend_object* object TSRMLS_DC);
static zend_object* qh_object_new_intstringhash(zend_class_entry *class_type TSRMLS_DC);
...
static inline zend_object* qh_object_new_intstringhash_ex(zend_class_entry *class_type, php_qh_intstringhash_obj **ptr TSRMLS_DC)
{
