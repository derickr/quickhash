...
/* iterator handlers */
static void qh_inthash_it_dtor(zend_object_iterator *iter TSRMLS_DC)
{
	qh_inthash_it *iterator = (qh_inthash_it *)iter;
...
static void qh_inthash_it_current_data(zend_object_iterator *iter, zval ***data TSRMLS_DC)
{
	qh_inthash_it *iterator = (qh_inthash_it *)iter;
...
static int qh_inthash_it_current_key(zend_object_iterator *iter, char **str_key, uint *str_key_len, ulong *int_key TSRMLS_DC)
{
	qh_inthash_it   *iterator = (qh_inthash_it *)iter;
...
static void qh_inthash_it_move_forward(zend_object_iterator *iter TSRMLS_DC)
{
	qh_inthash_it   *iterator = (qh_inthash_it *)iter;
}

static void qh_inthash_it_rewind(zend_object_iterator *iter TSRMLS_DC)
{
	qh_inthash_it *iterator = (qh_inthash_it *)iter;
...
zend_object_iterator_funcs qh_inthash_it_funcs = {
	...
	qh_inthash_it_current_data,
	qh_inthash_it_current_key,
	qh_inthash_it_move_forward,
	qh_inthash_it_rewind,
	NULL
};

zend_object_iterator *qh_inthash_get_iterator(zend_class_entry *ce, zval *object, int by_ref TSRMLS_DC)
{
	qh_inthash_it  *iterator = emalloc(sizeof(qh_inthash_it));
	php_qh_inthash_obj  *obj    = (php_qh_inthash_obj *)zend_object_store_get_object(object TSRMLS_CC);
